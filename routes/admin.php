...
Route::middleware(['auth:admin'])->prefix('admin')->group(function () {
    ...
    Route::prefix('data')->group(function () {
        Route::prefix('mahasiswa')->group(function () {
            ...
            Route::post('/update', [AdminMahasiswaController::class, 'update'])->name('admin.data.mahasiswa.update');
        ...
        Route::prefix('pembimbing-akademik')->group(function () {
            ...
            Route::post('/update', [AdminPembimbingAkademikController::class, 'update'])->name('admin.data.pembimbing-akademik.update');
        ...
        Route::prefix('pembimbing-lapangan')->group(function () {
            ...
            Route::post('/update', [AdminPembimbingLapanganController::class, 'update'])->name('admin.data.pembimbing-lapangan.update');
        ...
        Route::prefix('program-studi')->group(function () {
            ...
            Route::post('/update', [AdminProgramStudiController::class, 'update'])->name('admin.data.program-studi.update');
        ...
        Route::prefix('kelas')->group(function () {
            ...
            Route::post('/update', [AdminKelasController::class, 'update'])->name('admin.data.kelas.update');
