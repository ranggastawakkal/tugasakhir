...
@section('title','Tambah Pembimbing Lapangan')
...
<div class="card shadow mb-4">
    ...
    <form method="POST" action="{{ route('mahasiswa.pembimbing.lapangan.store.new') }}">
        ...
        <div class="form-group row">
            <label for="nama" class="col-md-2 col-form-label text-md-left ml-2 font-weight-bold">Nama</label>
        ...
        <div class="form-group row">
            <label for="nip" class="col-md-2 col-form-label text-md-left ml-2 font-weight-bold">NIP</label>
        ...
        <div class="form-group row">
            <label for="phone" class="col-md-2 col-form-label text-md-left ml-2 font-weight-bold">No. Telepon</label>
        ...
        <div class="form-group row">
            <label for="jabatan" class="col-md-2 col-form-label text-md-left ml-2 font-weight-bold">Jabatan</label>
        ...
        <div class="form-group row">
            <label for="namaperusahaan" class="col-md-2 col-form-label text-md-left ml-2 font-weight-bold">Nama Perusahaan</label>
        ...
        <div class="form-group row">
            <label for="alamatperusahaan" class="col-md-2 col-form-label text-md-left ml-2 font-weight-bold">Alamat Perusahaan</label>
        ...
        <div class="form-group row">
            <label for="kotaperusahaan" class="col-md-2 col-form-label text-md-left ml-2 font-weight-bold">Kota Perusahaan</label>
        ...
        <div class="form-group row">
            <label for="email_perusahaan" class="col-md-2 col-form-label text-md-left ml-2 font-weight-bold">Email Perusahaan</label>
        ...
        <div class="form-group row">
            <label for="phoneperusahaan" class="col-md-2 col-form-label text-md-left ml-2 font-weight-bold">No. Telepon Perusahaan</label>
