        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="POST" action="{{ route('admin.data.program-studi.store') }}">
                    @csrf
                    <div class="mb-3">
                        <label for="nama_prodi" class="col-form-label font-weight-bold">Nama Program Studi:</label>
...
<div class="modal fade" id="modalTampilData{{ $prodi->id }}" tabindex="-1" aria-labelledby="modalTampilDataLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="modalTampilDataLabel">Detail Data Program Studi</h5>
                <button class="close" type="button" data-bs-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">×</span>
                </button>
            </div>
